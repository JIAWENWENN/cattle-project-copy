...
defineOptions({
    layout: (h, page) => h(AppLayout, { title: 'Monthly Calving Record', parent: 'Calving', parentUrl: '/calving' }, () => page)
});
...
const form = useForm({
    ...
    calving_date: '',
    operating_unit: props.operatingUnit || '',
    sex: 'MC',
    colour: 'Merah (Red)',
...
const submitForm = () => {
    ...
    console.log('Submitting form to POST /calving...');
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select v-model="form.location_block" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg bg-white text-sm outline-none focus:ring-2 focus:ring-[#34554a]">
                            ...
                            <option v-for="block in props.allBlocks" :key="block" :value="block">{{ toTitleCase(block) }}</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select v-model="form.location_phase" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg bg-white text-sm outline-none focus:ring-2 focus:ring-[#34554a]">
                            ...
                            <option v-for="phase in props.allPhases" :key="phase" :value="phase">{{ toTitleCase(phase) }}</option>
                        </select>
                    </div>
                </div>
            </div>
