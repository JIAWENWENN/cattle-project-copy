...
defineOptions({
    layout: (h, page) => h(AppLayout, { title: 'Create CTV', parent: 'Transfer', parentUrl: '/transfer/ctv' }, () => page)
});
...
const form = useForm({
    ...
    customer_name: '',
    livestock: [
        { row_key: Date.now(), tag_no: '', category: 'WB', colour: '', weight: null, condition_good: true, condition_not_good: false, remarks: '', purpose: '' }
    ]
});
...
const addLivestock = () => {
    form.livestock.push({ row_key: Date.now() + Math.random(), tag_no: '', category: 'WB', colour: '', weight: null, condition_good: true, condition_not_good: false, remarks: '', purpose: '' });
};
    ...
    <div class="w-full max-w-6xl mx-auto">
        <div class="mb-8 flex justify-between items-center">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Create cattle transfer voucher (CTV)</h1>
                    <p class="text-sm text-gray-500 mt-1">Use the same workflow styling as calving module</p>
                </div>
            </div>
