...
defineOptions({
    layout: (h, page) => h(AppLayout, { title: 'Create Receival', parent: 'Transfer', parentUrl: '/transfer/receival' }, () => page)
});
...
const form = useForm({
    ...
    customer_name: '',
    livestock: [
        { row_key: Date.now(), tag_no: '', category: 'WB', colour: '', weight: null, condition_good: true, condition_not_good: false, remarks: '', purpose: '', yard: '' }
    ]
});
...
const submitForm = () => {
    ...
    form.post('/transfer', {
        onSuccess: () => alert('Receival saved successfully'),
        onError: (errors) => {
            const message = Object.values(errors || {}).flat().join('\n') || 'Failed to save Receival';
            alert(message);
        }
    });
};
...
const goBack = () => {
    router.visit('/transfer/receival');
};
</script>
    ...
    <div class="w-full max-w-7xl mx-auto">
        <div class="mb-8 flex justify-between items-center">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Create cattle receival form</h1>
                    <p class="text-sm text-gray-500 mt-1">Styled to match calving module form design</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-6">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <input v-model="form.vehicle_no" type="text" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg bg-white text-sm outline-none focus:ring-2 focus:ring-[#34554a]" required>
                    </div>
                    <div>
